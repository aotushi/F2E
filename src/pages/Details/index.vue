...
export default {
	...
	methods: {
		...
		// 排它步骤:1.所有成员变为同一种状态 2.点击的这个成员变为另一种状态
		changeColor(spuSaleAttrValue, spuSaleAttrValueList) {
	...
	computed: {
		...
		imgList() {
			// 或一个数组的原因. skuInfo是异步请求的数据. 当数据请求回来之前,这个值就是undefined. 添加或空数组,确保最后不是undefined,浏览器不会报错.
