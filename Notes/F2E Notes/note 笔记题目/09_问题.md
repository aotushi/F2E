...
|名称及比较| `block`                                                     | `inline-block`                             | `inline`                                                     |
| ---------------------------- | ----------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------ |
...
**相同点**: 使JS文件异步加载，即html执行到script标签时，JS加载和文档解析同时进行.
**不同点:**
* async是在JS加载完成后, 立即执行JS脚本，可以在DOM尚未完全下载完成就加载和执行,阻塞文档解析
* defer则是JS加载完成后，在文档解析完成后,再执行JS脚本

[结论]([javascript - 浅谈script标签的defer和async - 总总 - SegmentFault 思否](https://segmentfault.com/a/1190000006778717)): 
...
vue3.0 也全面改用 TypeScript 来重写了，更是使得对外暴露的 api 更容易结合 TypeScript。静态类型系统对于复杂代码的维护确实很有必要.
...
![fc95bf60-3ac6-11eb-ab90-d9ae814b240d](https://cdn.staticaly.com/gh/aotushi/image-hosting@master/documentation/fc95bf60-3ac6-11eb-ab90-d9ae814b240d.3qhhp95pi200.webp)
...
![](https://cdn.staticaly.com/gh/aotushi/image-hosting@master/documentation/.3gam4th7xli0.webp)
