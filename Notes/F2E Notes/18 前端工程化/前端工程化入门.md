...
3. [【前端规范全攻略】开启高效开发之旅！ESLint + Prettier + husky + lint-staged+Commitizen - 掘金 (juejin.cn)](https://juejin.cn/post/7257441221761040444) 主要是按照这个
...
```bash
npm i eslint-config-prettier esilnt-plugin-prettier
```
...
```bash
npm i commitizen cz-convetional-changelog
```
